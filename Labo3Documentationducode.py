m = "Mage"           #Les lignes 1 à 11 sont mes variables pour mes armes, mes personnages et mes niveaux.
p = "Paladin"
a = "Assassin"
bfe = "Bâton de feu"
bf = "Bâton de foudre"
...
if Personnage == "m":
    ...
    Personage_choisi = m   #Les lignes 16 à 37 sont pour que chaque personnage est ses deux seuls fois d'armes et pas d'autres choix.
...
Niveau = input("Choisissez votre niveau entre Donjon (d) et Forêt (f)\n: ") # Cette ligne sert seulement à donner le choix entre les deux niveaux.